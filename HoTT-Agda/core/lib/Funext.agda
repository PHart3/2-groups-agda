...
module _ {j} {B : A → Type j} {f₁ f₂ f₃ f₄ f₅ f₆ : Π A B} where

  ∙5-λ= : (α₁ : f₁ ∼ f₂) (α₂ : f₂ ∼ f₃) (α₃ : f₃ ∼ f₄) (α₄ : f₄ ∼ f₅) (α₅ : f₅ ∼ f₆)
    →
    λ= α₁ ◃∙ λ= α₂ ◃∙ λ= α₃ ◃∙ λ= α₄ ◃∙ λ= α₅ ◃∎
      =ₛ
    λ= (λ x → α₁ x ∙ α₂ x ∙ α₃ x ∙ α₄ x ∙ α₅ x) ◃∎
  ∙5-λ= α₁ α₂ α₃ α₄ α₅ = 
    λ= α₁ ◃∙ λ= α₂ ◃∙ λ= α₃ ◃∙ λ= α₄ ◃∙ λ= α₅ ◃∎
      =ₛ⟨ 3 & 2 & ∙-λ= α₄ α₅ ⟩
    _
      =ₛ⟨ 2 & 2 & ∙-λ= α₃ (λ x → α₄ x ∙ α₅ x) ⟩
    _
      =ₛ⟨ 1 & 2 & ∙-λ= α₂ (λ x → α₃ x ∙ α₄ x ∙ α₅ x) ⟩
    _
      =ₛ⟨ 0 & 2 & ∙-λ= α₁ (λ x → α₂ x ∙ α₃ x ∙ α₄ x ∙ α₅ x) ⟩
    λ= (λ x → α₁ x ∙ α₂ x ∙ α₃ x ∙ α₄ x ∙ α₅ x) ◃∎ ∎ₛ
