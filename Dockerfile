...
RUN agda --library-file=/root/.agda/libraries --ignore-interfaces ./Grp-Type-biequiv/Biequiv-main.agda
CMD ["agda", "--html", "--library-file=/root/.agda/libraries", "./Grp-Type-biequiv/Biequiv-main.agda"]
