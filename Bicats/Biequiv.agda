...
module _ {i₁ i₂ j₁ j₂} {B@(B₀ , _) : Bicat j₁ i₁} {C@(C₀ , _) : Bicat j₂ i₂} where
  ...
  baeqv-to-niso : (be : BiequivStr ξB ξC) → Biequiv-coh (ε be) (η be) → HAdjEquiv-wc (bc-to-wc B) (bc-to-wc C)
  ...
  baeqv-is-ff : (be : BiequivStr ξB ξC) → Biequiv-coh (ε be) (η be) →
