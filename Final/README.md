...
- Comment out the final four imports in `Final-thms.agda` to reduce the amount of type-checking
  by over half. Doing so will check all relevant type equivalences but not the biequivalence
  (which takes up most of the total time).
