...
module _ {i} {G : Type i} {{η : CohGrp G}} where 
  ...
  abstract
    LoopK-coher-unit :
      natiso2G-to-== (unit-wkmaghom-l (grphom-forg K₂-loopmap)) ∙
      ...
      idp
        ==
      natiso2G-to-== (unit-wkmaghom-r (grphom-forg K₂-loopmap))
    LoopK-coher-unit = =ₛ-out $
      ...
      natiso2G-to-== (natiso-id2G (K₂-loopmap ∘2G cohgrphom (idf G) {{idf2G}})) ◃∎
       =ₛ⟨ ∘2G-conv-quint
             (unit-wkmaghom-l (grphom-forg K₂-loopmap))
     ...
     natiso2G-to-==
       ...
       =ₛ₁⟨ ap natiso2G-to-==
              (natiso∼-to-== (λ x →
              aux (ap-idf (loop x)) (WkMagNatIso.θ (Loop2Grp-map-ap K₂-map-idf) (loop x)) (K₂-map-β-pts idf2G x) ∙
              =ₛ-out (LoopK-idf {{η}} x))) ⟩
     natiso2G-to-== (unit-wkmaghom-r (grphom-forg K₂-loopmap)) ◃∎ ∎ₛ
       where abstract
