...
module Equality-main (i : ULevel) where
  ...
  2Grp-Ptd02-eql-K₂ = baequiv-to-== qu-2G qu-Pt02 (2Grp-Ptd02-baeq i)
  ...
  2Grp-Ptd02-eql-Ω =
    ...
    let
      equiv-wc_rev = HAEquiv-wc-reverse (beqv-to-niso (2Grp-Ptd02-baeq i))
      open Psfunctor
    in
    iso-bc-to-== (BiequivStr-inst.Ψ₂ (2Grp-Ptd02-bieq i) ,
      ...
      λ x y → HAEquiv-wc-ff equiv-wc_rev {x} {y})
